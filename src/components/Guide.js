...
const guides = [
  ...
  { src: require('../lib/img/guide/guide3.JPG'), alt: '가이드3', desc: '3. TAG검색 화면입니다. 원하시는 필터를 선택하시고 검색 버튼을 클릭하시면 조회가 됩니다.' },
  { src: require('../lib/img/guide/guide4.JPG'), alt: '가이드4', desc: '4. TAG선택창 입니다. 원하시는 TAG를 선택하시면 TAG 아이템이 조회됩니다.' },
  ...
  { src: require('../lib/img/guide/guide13.JPG'), alt: '가이드13', desc: '13. 캐릭터가 장착중인 아이템 TAG요약이 표시 됩니다. 보유한 TAG가 많은 순서대로 정렬됩니다.' },
  { src: require('../lib/img/guide/guide14.JPG'), alt: '가이드14', desc: '14. 보유 아이템 전체 시트 신규 기능입니다. 보유한 아이템의 전체 TAG요약이 표시됩니다. TAG가 많은 순서대로 정렬되어 세팅하시는데 참고하시면 됩니다. TAG요약 숨기기 버튼을 누르면 보유 아이템 TAG요약이 숨김 처리 됩니다.' },
